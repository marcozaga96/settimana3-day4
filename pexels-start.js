const pexelsImage = function (img) {
  fetch("https://api.pexels.com/v1/search?query=" + img, {
    headers: {
...
changeImages1.addEventListener("click", () => {
  pexelsImage("panorama");
});
changeImages2.addEventListener("click", () => {
  pexelsImage("dogs");
});
